...
(qsci.SCI_LINESCROLLDOWN, 'mEdit/mSelection/aScrollViewDownOneLine', tr('Scroll view down one line'), 'Ctrl+Down'),
...
(qsci.SCI_VCHOME, 'mEdit/mNavigation/aMoveToFirsstVCInLine', tr('Move to firsst VC in line'), 'Home'),
...
(qsci.SCI_LINEEND, 'mEdit/mNavigation/aMoveToEndOfLine', tr('Move to end of line'), 'End'),
...
(qsci.SCI_SELECTALL, 'mEdit/mEdit/aSelectAll', tr('Select All'), 'Ctrl+A'),
