...
class EditorConfigurator():  # FIXME ModuleConfigurator
    ...
    def _createEditorSettings(self, dialog):
        ...
        (
            ...
            CheckableOption(dialog, cfg, "Editor/Indentation/AutoIndent", dialog.cbAutoIndent),
            CheckableOption(dialog, cfg, "Editor/Indentation/BackspaceUnindents", dialog.cbBackspaceUnindents),
            ...
            CheckableOption(dialog, cfg, "Editor/Wrap/Enabled", dialog.gbWrapModeEnabled),
            ChoiseOption(dialog, cfg, "Editor/Wrap/Mode",
                         {dialog.rbWrapCharacter: "WrapCharacter",
                          dialog.rbWrapWord: "WrapWord"}),
            ChoiseOption(dialog, cfg, "Editor/Wrap/StartVisualFlag",
                         {dialog.rbStartWrapFlagNone: "None",
                          dialog.rbStartWrapFlagByText: "ByText",
                          dialog.rbStartWrapFlagByBorder: "ByBorder"}),
            ChoiseOption(dialog, cfg, "Editor/Wrap/EndVisualFlag",
                         {dialog.rbEndWrapFlagNone: "None",
                          dialog.rbEndWrapFlagByText: "ByText",
                          dialog.rbEndWrapFlagByBorder: "ByBorder"}),
            NumericOption(dialog, cfg, "Editor/Wrap/LineIndentWidth", dialog.sWrappedLineIndentWidth)
        ))
