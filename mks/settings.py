...
"Editor/Assotiations/Fortran" : ['*.f *.for *.ftn'],
"Editor/Assotiations/Fortran77" : [''],
...
"Editor/Assotiations/Pascal" : ['*.pas'],
"Editor/Assotiations/Perl" : ['*.ph', '*.pl', '*.pm'],
"Editor/Assotiations/POV" : ['*.pov'],
"Editor/Assotiations/PostScript" : ['*.ps'],
