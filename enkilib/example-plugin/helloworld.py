...
# core is main enkilib.core singletone. It is usually used for getting pointers to other singletones
from enkilib.core.core import core

import enkilib.widgets.dockwidget

class MyDock(enkilib.widgets.dockwidget.DockWidget):
    def __init__(self):
        enkilib.widgets.dockwidget.DockWidget.__init__(self)
...
from enkilib.core.uisettings import TextOption
...
class Plugin:
    """During initialization, core imports all modules and packages in **enkilib/plugins** directory,
