...
Classes:
    * :class:`enkilib.core.abstractdocument.AbstractDocument`
    * :class:`enkilib.core.abstractdocument.AbstractTextEditor`
    * :class:`enkilib.core.abstractdocument.IndentHelper`
"""
...
class IndentHelper:
    ...
    See :meth:`enkilib.core.core.Core.indentHelper`, :meth:`enkilib.core.core.Core.setIndentHelper`
    """
...
class AbstractTextEditor(AbstractDocument):
    ...
    **Signal** emitted, after new line has been inserted by user (user pressed Enter)
    ...
    def setLanguage(self, language):
        ...
        Called Only by :class:`enkilib.plugins.associations.Associations` to select syntax highlighting language.
        """
