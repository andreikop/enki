...
* *Option classes.
  ...
  config may be either :class:`enkilib.core.config.Config` or python dictionary
* :class:`enkilib.core.uisettings.UISettingsManager`. Invokes the dialogue.
...
#. :class:`enkilib.core.uisettings.UISettingsManager` emits **aboutToExecute**
#. Each plugins adds own options to the dialogue
#. Each option loads its value from the :class:`enkilib.core.config.Config`
#. The user edits settigns
#. The user clicks *OK*
#. Each option writes it's new value to the config
#. :class:`enkilib.core.uisettings.UISettingsManager` emits **dialogAccepted**
...
-------
Main classes:
    * :class:`enkilib.core.uisettings.UISettings` - settings dialogue. Created when shall be executed
    * :class:`enkilib.core.uisettings.UISettingsManager` - manager. Exists always

Option types:
    * :class:`enkilib.core.uisettings.CheckableOption` - bool option, CheckBox
    * :class:`enkilib.core.uisettings.TextOption` - string option, line edit
    * :class:`enkilib.core.uisettings.ListOnePerLineOption` - list of strings option, text edit
    * :class:`enkilib.core.uisettings.NumericOption` - numeric option, any numeric control
    * :class:`enkilib.core.uisettings.ColorOption` - color option, button
    * :class:`enkilib.core.uisettings.FontOption` - font option, button
    * :class:`enkilib.core.uisettings.ChoiseOption` - string from the set option, combo box
...
from enkilib.core.core import core, DATA_FILES_PATH
...
class ColorOption(Option):
    ...
    Control must be enkilib.widgets.ColorButton
    """
    def load(self):
        """Load the value from config to GUI
        """
...
class UISettingsManager(QObject):  # pylint: disable=R0903
    ...
    """
    aboutToExecute(:class:`enkilib.core.uisettings.UISettings`)
