...
from enkilib.lib.htmldelegate import HTMLDelegate
...
class AbstractCommand:
    ...
    def pattern():
        ...
        See `workspace_commands <https://github.com/hlamer/enki/blob/master/enkilib/plugins/workspace_commands.py>` as example
        """
        raise NotImplemented()
    ...
    def completer(self, text, pos):
        """ ::class:`enkilib.core.locator.AbstractCompleter` instance for partially typed command.
