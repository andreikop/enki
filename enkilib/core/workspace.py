...
Document classes are herited from :class:`enkilib.core.abstractdocument.AbstractDocument`

:class:`enkilib.core.workspace.Workspace`
"""
...
import enkilib.core.openedfilemodel
from enkilib.core.abstractdocument import AbstractDocument
...
class Workspace(QStackedWidget):
    ...
    """
    documentOpened(:class:`enkilib.core.abstractdocument.AbstractDocument`)
    ...
    **Signal** emitted, when document has been created, i.e. textual file opened, 
    ...
    """
    documentClosed(:class:`enkilib.core.abstractdocument.AbstractDocument`)
    ...
    **Signal** emitted, when document was closed
    ...
    currentDocumentChanged = pyqtSignal(AbstractDocument,
                                        AbstractDocument)
    """
    currentDocumentChanged(:class:`enkilib.core.abstractdocument.AbstractDocument` old, 
    :class:`enkilib.core.abstractdocument.AbstractDocument` current)
    ...
    **Signal** emitted, when indentation mode has been changed
    ...
    def __init__(self, mainWindow):
        ...
        List accessed and modified by enkilib.core.openedfilemodel.OpenedFileModel class
        """
        ...
        self.openedFileExplorer = enkilib.core.openedfilemodel.OpenedFileExplorer(self)
    ...
    def setTextEditorClass(self, newEditorClass):
        ...
        newEditorClass is class, herited from :class:`enkilib.core.abstractdocument.AbstractDocument`
        """
        self._textEditorClass = newEditorClass
    
    def textEditorClass(self):
        """Get text editor, which is used for open textual documents.
        Text editor is class, herited from :class:`enkilib.core.abstractdocument.AbstractDocument`
        """
    ...
    def documents(self):
        """Get list of opened documents (:class:`enkilib.core.abstractdocument.AbstractDocument` instances)
        """
