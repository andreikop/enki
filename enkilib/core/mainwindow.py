...
Module contains :class:`enkilib.core.mainwindow.MainWindow` implementation
"""
...
from enkilib.widgets.dockwidget import DockWidget
from enkilib.core.actionmanager import ActionMenuBar
...
class MainWindow(QMainWindow):
    ...
    **Signal** emitted, when user drag-n-dropt directory to main windowd.
    ...
    _STATE_FILE = os.path.join(enkilib.core.defines.CONFIG_DIR, "main_window_state.bin")
    _GEOMETRY_FILE = os.path.join(enkilib.core.defines.CONFIG_DIR, "main_window_geometry.json")
    ...
    def __init__(self):
        ...
        self.setWindowIcon( QIcon(':/enkiicons/enki.png') )
    ...
    def defaultTitle(self):
        ...
        """
        return "%s v.%s" % (enkilib.core.defines.PACKAGE_NAME, enkilib.core.defines.PACKAGE_VERSION)
    ...
    def appendMessage(self, text, timeoutMs=10000):
        ...
        if self._queuedMessageToolBar is None:
            from enkilib.core.QueuedMessageToolBar import QueuedMessageToolBar
