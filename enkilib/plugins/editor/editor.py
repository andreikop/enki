...
from enkilib.core.abstractdocument import AbstractTextEditor
...
class Editor(AbstractTextEditor):
    ...
    def _initQsciShortcuts(self):
        ...
        Other shortcuts are disabled, or are configured with enkilib.plugins.editorshortcuts and defined here
        """
    ...
    def _applyLanguage(self, language):
        ...
        Called Only by :mod:`enkilib.plugins.associations` to select syntax highlighting language.
        """
