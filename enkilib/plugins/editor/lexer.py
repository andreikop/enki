...
def _getPygmentsSchemeLexer(editor):
    ...
    """
    try:
        import enkilib.plugins.editor.lexerpygments
    except ImportError:
        ...
        return None
    return enkilib.plugins.editor.lexerpygments.LexerPygments(editor, 'Scheme')
...
class Lexer:
    ...
    * Apply lexer settings
    ...
    def __init__(self, editor):
        """editor - reference to parent :class:`enkilib.plugins.editor.Editor` object
        """
        self._editor = editor
