...
import enkilib.lib.buffpopen
import enkilib.widgets.termwidget
...
class MitSchemeTermWidget(enkilib.widgets.termwidget.TermWidget):
    """Terminal emulator widget
    """
    def __init__(self, mitScheme, *args):
        enkilib.widgets.termwidget.TermWidget.__init__(self, *args)
...
class MitScheme(QObject):
    ...
    **Signal** emitted, when MIT Scheme process starts and stops
    ...
    def __init__(self, interpreterPath):
        ...
        self._buffPopen = enkilib.lib.buffpopen.BufferedPopen(interpreterPath)
