...
struct CtagsEntity
    CtagsEntity(  QString& s ) { mList = s.split( '\t' );
    
    QString getName()  { return mList.value( 0 ).trimmed();
    QString getFile()  { return mList.value( 1 ).trimmed();
    QString getAddress()  { return mList.value( 2 ).trimmed();
    ...
    QString getKindValue()  { return getFieldValue( "kind" );
    ...
    QString getKindDefaultValue()  { return getFieldValue( getKindDefaultField() );
