...
def install(self):
    ...
    connect( MonkeyCore.consoleManager(), SIGNAL( started() ), self, SLOT( onConsoleStarted() ) )
...
def uninstall(self):
    ...
    # disconnections
    disconnect( MonkeyCore.consoleManager(), SIGNAL( started() ), self, SLOT( onConsoleStarted() ) )
