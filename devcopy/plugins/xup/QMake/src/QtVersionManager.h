...
struct QtItem
    QtItem() {
    QtItem(  QString& t, v, s, h = QString.null )
        : Text( t ), Value( v ), Variable( s ), Help( h ) {

    bool operator==(  QtItem& o ) { return Text == o.Text and Value == o.Value and Variable == o.Variable and Help == o.Help;
    bool operator!=(  QtItem& o ) { return not operator==( o );
