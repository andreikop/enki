...
QtAssistantChild.QtAssistantChild( QHelpEngine* engine, parent )
    ...
    isSearch.toolNext.clicked.connect(self.findNext)
    isSearch.editFind.returnPressed.connect(self.findNext)
    isSearch.editFind.textChanged.connect(self.findCurrentText)
    isSearch.toolPrevious.clicked.connect(self.findPrevious)
