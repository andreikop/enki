...
namespace SharedToolsnamespace Internal
class SizeHandleRect : public QWidget
    Q_OBJECT
public:
    enum Direction { LeftTop, Top, RightTop, Right, RightBottom, Bottom, LeftBottom, Left

    SizeHandleRect(QWidget *parent, d, *resizable)

    Direction dir()   { return m_dir;
    void updateCursor()
    void setState(SelectionHandleState st)

signals:

    void mouseButtonReleased( QRect &, &)
