...
public:
    ...
    inline qdesigner_internal.QDesignerIntegration* integration()
        return mIntegration

    inline QAction* editWidgetsAction()
        return aEditWidgets

    inline QWidgetAction* previewFormAction()
        return aPreview

    inline QList<QAction*> modesActions()
        return aModes.actions()
