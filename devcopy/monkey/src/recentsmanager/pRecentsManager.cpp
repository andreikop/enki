...
pRecentsManager.pRecentsManager( QObject* p )
    ...
    # connections
    MonkeyCore.menuBar().menu( "mFile/mRecents" ).triggered.connect(self.recentFiles_triggered)
    MonkeyCore.menuBar().menu( "mProject/mRecents" ).triggered.connect(self.recentProjects_triggered)
