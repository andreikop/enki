...
class Q_MONKEY_EXPORT UITemplatesWizard : public QDialog, Ui.UITemplatesWizard
    Q_OBJECT

public:
    UITemplatesWizard( parent = 0 )
...
private slots:
    ...
    void on_cbProjects_currentChanged(  QModelIndex& index )
