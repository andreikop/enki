...
'''
def isSameFile(  QString& left, right ):
    # get file info
    QFileInfo fif  left :
    QFileInfo fio( right )
...
'''
def getFolders( QDir fromDir, filters, recursive ):
    QFileInfoList files
...
'''!
    ...
    \param recursive If True, folders are scanned recursively, not
'''
def getFiles( QDir fromDir, filters, recursive ):
    QFileInfoList files
...
'''!
    ...
    \param recursive If True, folders are scanned recursively, not
'''
def getFiles( QDir fromDir, filter, recursive ):
    return getFiles( fromDir, filter.isEmpty() ? QStringList() : QStringList( filter ), recursive )


def getOpenDialog( QFileDialog.FileMode fileMode, caption, fileName, filter, parent, QFileDialog.acceptMode = QFileDialog.AcceptOpen ):
    # create dialg
...
'''
def getImageFileNames(  QString& caption, fileName, parent ):
    # get image filters
    QStringList filters
...
'''!
    ...
    \param parent The parent widget
'''
def getImageFileName(  QString& caption, fileName, parent ):
...
'''!
    ...
    \param parent The parent widget
'''
def getOpenFileNames(  QString& caption, fileName, filter, parent ):
    # create dialg
...
'''!
    ...
    \param parent The parent widget
'''
def getOpenFileName(  QString& caption, fileName, filter, parent ):
...
'''!
    ...
    \param parent The parent widget
'''
def getSaveFileName(  QString& caption, fileName, filter, parent ):
    # create dialg
...
'''!
    ...
    \param parent The parent widget
'''
def getExistingDirectory(  QString& caption, fileName, parent ):
...
'''
def tokenizeHome(  QString& string ):
...
'''
def unTokenizeHome(  QString& string ):
...
'''
def setLexerProperty(  QString& property, lexer, value ):
...
'''
def lexerProperty(  QString& property, lexer ):
...
'''
def showMacFocusRect( QWidget* widget, show, recursive ):
...
'''!
    ...
    \param recursive If True, are updated too, not
'''
def setMacSmallSize( QWidget* widget, small, recursive ):
    QList<QWidget*> widgets
...
'''
def setSaveFilesOnCustomAction( bool save ):
...
'''
def setTabsHaveCloseButton( bool have ):
...
'''
def setTabsHaveShortcut( bool have ):
...
'''
def setTabsTextColor(  QColor& color ):
...
'''
def setCurrentTabTextColor(  QColor& color ):
...
'''
def setDocumentMode( pWorkspace.ViewMode mode ):
...
'''
def setSaveSessionOnClose( bool save ):
...
'''
def setRestoreSessionOnStartup( bool restore ):
...
'''
def setShowQuickFileAccess( bool show ):
...
'''
def setOpenedFileSortingMode( pOpenedFileModel.SortMode mode ):
...
'''
def setAutoSyntaxCheck( bool activate ):
...
'''
def setConvertTabsUponOpen( bool convert ):
...
'''
def setCreateBackupUponOpen( bool backup ):
...
'''
def setAutoEolConversion( bool convert ):
...
'''
def setDefaultCodec(  QString& codec ):
...
'''
def setSelectionBackgroundColor(  QColor& color ):
...
'''!
    ...
    \param color The color to apply
'''
def setSelectionForegroundColor(  QColor& color ):
...
'''
def setDefaultDocumentColours( bool useDefault ):
...
'''!
    ...
    \param color The color to apply
'''
def setDefaultDocumentPen(  QColor& color ):
...
'''!
    ...
    \param color The color to apply
'''
def setDefaultDocumentPaper(  QColor& color ):
...
'''
def setDefaultDocumentFont(  QFont& font ):
...
'''
def setAutoCompletionCaseSensitivity( bool sensitive ):
...
'''
def setAutoCompletionReplaceWord( bool replace ):
...
'''
def setAutoCompletionShowSingle( bool show ):
...
'''
def setAutoCompletionSource( QsciScintilla.AutoCompletionSource mode ):
...
'''
def setAutoCompletionThreshold( int count ):
...
'''!
    ...
    \param color The color to apply
'''
def setCallTipsBackgroundColor(  QColor& color ):
...
'''!
    ...
    \param color The color to apply
'''
def setCallTipsForegroundColor(  QColor& color ):
...
'''!
    ...
    \param color The color to apply
'''
def setCallTipsHighlightColor(  QColor& color ):
...
'''
def setCallTipsStyle( QsciScintilla.CallTipsStyle style ):
...
'''
def setCallTipsVisible( int count ):
...
'''
def setAutoIndent( bool autoindent ):
...
'''
def setBackspaceUnindents( bool unindents ):
...
'''
def setIndentationGuides( bool visible ):
...
'''
def setIndentationsUseTabs( bool tabs ):
...
'''
def setAutoDetectIndent( bool detect ):
...
'''
def setIndentationWidth( int width ):
...
'''!
    ...
    \param color The color to apply
'''
def setIndentationGuidesBackgroundColor(  QColor& color ):
...
'''!
    ...
    \param color The color to apply
'''
def setIndentationGuidesForegroundColor(  QColor& c ):
...
'''!
    ...
    \param mode The mode to apply
'''
def setBraceMatching( QsciScintilla.BraceMatch mode ):
...
'''!
    ...
    \param color The color to apply
'''
def setMatchedBraceBackgroundColor(  QColor& color ):
...
'''!
    ...
    \param color The color to apply
'''
def setMatchedBraceForegroundColor(  QColor& color ):
...
def setUnmatchedBraceBackgroundColor(  QColor& c ):
...
def setUnmatchedBraceForegroundColor(  QColor& c ):
...
def setEdgeMode( QsciScintilla.EdgeMode m ):
...
def setCaretLineVisible( bool b ):
...
def setCaretLineBackgroundColor(  QColor& c ):
...
def setCaretForegroundColor(  QColor& c ):
...
def setLineNumbersMarginEnabled( bool b ):
...
def setLineNumbersMarginWidth( int i ):
...
def setLineNumbersMarginAutoWidth( bool b ):
...
def setFolding( QsciScintilla.FoldStyle f ):
...
def setFoldMarginBackgroundColor(  QColor& c ):
...
def setFoldMarginForegroundColor(  QColor& c ):
...
def setMarginsBackgroundColor(  QColor& c ):
...
def setMarginsForegroundColor(  QColor& c ):
...
def setEolMode( QsciScintilla.EolMode e ):
    MonkeyCore.settings().setValue( settingsPath() +"/EolMode", e )


def eolMode( pMonkeyStudio.OSVariant os ):
...
def getEol( QsciScintilla.EolMode e ):
    switch ( e )
...
def setAutoDetectEol( bool detect ):
...
def setWhitespaceVisibility( QsciScintilla.WhitespaceVisibility w ):
...
def setWrapMode( QsciScintilla.WrapMode w ):
...
def setWrapVisualFlagsEnabled( bool b ):
...
def setStartWrapVisualFlag( QsciScintilla.WrapVisualFlag f ):
...
def setEndWrapVisualFlag( QsciScintilla.WrapVisualFlag f ):
...
def setWrappedLineIndentWidth( int i ):
