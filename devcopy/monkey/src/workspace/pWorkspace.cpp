...
def handleDocument(self, document ):
    ...
    # update file menu
    document.modifiedChanged.connect(MonkeyCore.menuBar().action( "mFile/mSave/aCurrent" ).setEnabled)
    # update edit menu
    document.undoAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aUndo" ).setEnabled)
    document.redoAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aRedo" ).setEnabled)
    document.copyAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aCut" ).setEnabled)
    document.copyAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aCopy" ).setEnabled)
    document.pasteAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aPaste" ).setEnabled)
    # update status bar
    document.cursorPositionChanged.connect(MonkeyCore.statusBar().setCursorPosition)
    document.modifiedChanged.connect(MonkeyCore.statusBar().setModified)
...
def unhandleDocument(self, document ):
    ...
    # update file menu
    disdocument.modifiedChanged.connect(MonkeyCore.menuBar().action( "mFile/mSave/aCurrent" ).setEnabled)
    # update edit menu
    disdocument.undoAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aUndo" ).setEnabled)
    disdocument.redoAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aRedo" ).setEnabled)
    disdocument.copyAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aCut" ).setEnabled)
    disdocument.copyAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aCopy" ).setEnabled)
    disdocument.pasteAvailableChanged.connect(MonkeyCore.menuBar().action( "mEdit/aPaste" ).setEnabled)
    # update status bar
    disdocument.cursorPositionChanged.connect(MonkeyCore.statusBar().setCursorPosition)
    disdocument.modifiedChanged.connect(MonkeyCore.statusBar().setModified)
