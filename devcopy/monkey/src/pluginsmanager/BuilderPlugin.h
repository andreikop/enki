...
class Q_MONKEY_EXPORT BuilderPlugin : public BasePlugin, CLIToolPlugin
public:
    BuilderPlugin()
    virtual pCommand buildCommand()
    virtual void setBuildCommand(  pCommand& cmd )
    virtual QWidget* builderSettingsWidget()
    virtual pCommand defaultBuildCommand()  = 0
