# .. -*- coding: utf-8 -*-
#
#    Copyright (C) 2012-2013 Andrei Kopats and Bryan A. Jones.
#
...
#    with Enki.  If not, see <http://www.gnu.org/licenses/>.
#
# *******************************************************
# conf.py - Documentation generation for the Enki project
# *******************************************************
# This file configures Sphinx, which is used to transform both restructured text
# (reST) files and source code (.py) into a set of web pages which comprise
# Enki's documentation. See Sphinx `build configuration file docs
...
# ==============================================================================
# `project <http://sphinx-doc.org/config.html#confval-project>`_  and `copyright
# <http://sphinx-doc.org/config.html#confval-copyright>`_: General information
# about the project.
project = enki.core.defines.PACKAGE_NAME
copyright = enki.core.defines.PACKAGE_COPYRIGHTS
...
# `highlight_language
# <http://sphinx-doc.org/config.html#confval-highlight_language>`_: The default
# language to highlight source code in. **CodeChat note:** This should **not**
# be ``python``, since Sphinx will try to parse Python fragments and fail, then
# refuse to highlight the code.
...
# <http://sphinx-doc.org/config.html#confval-add_function_parentheses>`_: If
# true, '()' will be appended to :func: etc. cross-reference text.
##add_function_parentheses = True

# `add_module_names
# <http://sphinx-doc.org/config.html#confval-add_module_names>`_: If true, the
# current module name will be prepended to all description unit titles (such as
# .. function::).
...
# <http://sphinx-doc.org/config.html#confval-modindex_common_prefix>`_: A list
...
# `source_encoding
# <http://sphinx-doc.org/config.html#confval-source_encoding>`_: The encoding of
# source files.
##source_encoding = 'utf-8-sig'

# `master_doc <http://sphinx-doc.org/config.html#confval-master_doc>`_: The
# master toctree document. It shall be 'index'
# to display the docs correctly on rtfd.org
master_doc = 'index'
...
# `exclude_patterns
# <http://sphinx-doc.org/config.html#confval-exclude_patterns>`_: List of
# patterns, relative to source directory, that match files and directories to
# ignore when looking for source files. **CodeChat note:** This should always
# include the ``_build`` directory, which is where CodeChat's Sphinx output is
# placed.
exclude_patterns = [
  # Sphinx output
  '_build',
  # Windows bundle / installer output
  'build', 'dist',
  # Saves time by ignoring git files, which shouldn't be processed anyway.
  '.git']
...
# `html_theme_options
# <http://sphinx-doc.org/config.html#confval-html_theme_options>`_: Theme
# options are theme-specific and customize the look and feel of a theme further.
# **CodeChat note:** The sidebar confuses the web preview pane, so it is
# disabled.
...
# `html_theme_path
# <http://sphinx-doc.org/config.html#confval-html_theme_path>`_: Add any paths
# that contain custom themes here, relative to this directory.
##html_theme_path = []

# `html_title <http://sphinx-doc.org/config.html#confval-html_title>`_: The name
# for this set of Sphinx documents.  If None, it defaults to ``<project>
...
# sidebar.
html_logo = 'icons/logo/32x32/enki.png'
...
# large.
html_favicon = 'icons/logo/enki.ico'
...
#
#
# `Autodoc <http://sphinx-doc.org/ext/autodoc.html>`_ configuration
# =================================================================
# `autodoc_default_flags <http://sphinx-doc.org/ext/autodoc.html#confval-autodoc_default_flags>`_:
# This value is a list of autodoc directive flags that should be automatically
# applied to all autodoc directives.
autodoc_default_flags = [ 'members', 'undoc-members', 'show-inheritance']

# `autodoc_member_order <http://sphinx-doc.org/ext/autodoc.html#confval-autodoc_member_order>`_:
# This value selects if automatically documented members are sorted alphabetical
# (value ``'alphabetical'``), by member type (value ``'groupwise'``) or by
# source order (value ``'bysource'``).
autodoc_member_order = 'bysource'


# This provides a fake PyQt4 module, for building docs on systems without PyQt
# (such as `Read the Docs <https://readthedocs.org/>`_), based on their `FAQ
# <http://read-the-docs.readthedocs.org/en/latest/faq.html#my-project-isn-t-building-with-autodoc>`_.
