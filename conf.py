...
# *******************************************************
# This file configures Sphinx, which is used to transform both restructured text (reST) files and source code (.py) into a set of web pages which comprise Enki's documentation. See Sphinx `build configuration file docs <http://sphinx-doc.org/config.html>`_ for more information on the settings below.
#
...
# ==============================================================================
# `project <http://sphinx-doc.org/config.html#confval-project>`_  and `copyright <http://sphinx-doc.org/config.html#confval-copyright>`_: General information about the project.
...
# `highlight_language <http://sphinx-doc.org/config.html#confval-highlight_language>`_: The default language to highlight source code in. **CodeChat note:** This should **not** be ``python``, since Sphinx will try to parse Python fragments and fail, then refuse to highlight the code.
...
# =================================================================
# `autodoc_default_flags <http://sphinx-doc.org/ext/autodoc.html#confval-autodoc_default_flags>`_: This value is a list of autodoc directive flags that should be automatically applied to all autodoc directives.
autodoc_default_flags = [ 'members', 'undoc-members', 'show-inheritance']

# `autodoc_member_order <http://sphinx-doc.org/ext/autodoc.html#confval-autodoc_member_order>`_: This value selects if automatically documented members are sorted alphabetical (value ``'alphabetical'``), by member type (value ``'groupwise'``) or by source order (value ``'bysource'``).
autodoc_member_order = 'bysource'


# This provides a fake PyQt4 module, for building docs on systems without PyQt (such as `Read the Docs <https://readthedocs.org/>`_), based on their `FAQ <http://read-the-docs.readthedocs.org/en/latest/faq.html#my-project-isn-t-building-with-autodoc>`_.
