...
content"""
        webViewContent, logContent = self._doBasicSphinxTest('rst')
        self.assertTrue(u"<h1>österreich" in webViewContent)
...
.. Niederösterreich::"""
        ...
        self.assertFalse(u'Niederösterreich' in logContent)
        # Instead, a question mark replaces the unicode.
        self.assertTrue(u'Nieder?sterreich' in logContent)
